...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'Z4Money_SDK/1.0.0/php';
     ...
     * @return Configuration
     */
    public function setAuthentication($prefix = null, $token = null)
    {
        if ($prefix != null || $token != null) {
            $this->authentication[$prefix] = $token;
        }
     ...
     * @return Configuration
     */
    public function getAuthentication($key = null)
    {
        if (isset($key)) {
     ...
     * @return Configuration
     */
    public function setBearerAuth($token = null)
    {
        $this->authentication['Authorization'] = 'Bearer ' . $token;
